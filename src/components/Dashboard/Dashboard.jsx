    ...
    <main className="p-6 md:p-10 max-w-7xl mx-auto w-full min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <div className="glass-panel p-6 rounded-2xl border-l-4 border-emerald-500 card-hover relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-slate-400 text-xs font-bold uppercase tracking-widest">Total de Cabeças</h3>
        ...
        <div className="glass-panel p-6 rounded-2xl border-l-4 border-blue-500 card-hover relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-slate-400 text-xs font-bold uppercase tracking-widest">Nascimentos (Mês)</h3>
        ...
        <div className="glass-panel p-6 rounded-2xl border-l-4 border-[#d96b27] card-hover relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="bg-[#d96b27]/20 text-[#d96b27] text-xs px-2 py-1 rounded-md font-bold animate-pulse">Atenção</span>
            </div>
            ...
            <p className="text-[#d96b27] text-sm mt-3 flex items-center gap-1 font-medium">
              <i className="fa-solid fa-clock"></i> Vencimento próximo
            </p>
          </div>
        </div>
      </div>

      {/* Seção Extra: Para enriquecer o layout */}
      <div className="glass-panel rounded-2xl overflow-hidden border border-white/5">
        <div className="p-6 border-b border-white/5 flex justify-between items-center bg-white/[0.01]">
          <h3 className="text-lg font-bold text-white">Movimentações Recentes</h3>
          <button className="text-sm font-semibold text-[#d96b27] hover:text-[#c25c1f] transition-colors">Ver histórico</button>
        </div>
        ...
        <div className="p-0">
          ...
          <div className="flex items-center justify-between p-4 md:px-6 hover:bg-white/[0.03] transition-colors border-b border-white/5 cursor-pointer">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-500 text-xs">Lote #4713 • Nelore</p>
              </div>
            </div>
            <div className="text-right">
              <p className="text-emerald-400 font-bold text-sm">+ 55 cabeças</p>
          ...
          <div className="flex items-center justify-between p-4 md:px-6 hover:bg-white/[0.03] transition-colors cursor-pointer">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-white font-semibold text-sm">Aviso de Vacinação: Aftosa</p>
                <p className="text-slate-500 text-xs">Lote #4705 • Garrotes</p>
              </div>
            </div>
            <div className="text-right">
